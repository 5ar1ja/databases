--1. creating databse lab3
CREATE DATABASE lab3;

--2. download file lab3
...
--3. Select the last name of all employes
SELECT lastname FROM employees;

--4. Select the last name of all employees without duplicates
SELECT DISTINCT lastname FROM employees;

--5. Select all data of employees whose lasname is "Smith"
SELECT * FROM employees WHERE lastname = 'Smith';

--6. Select all data of employees whose lasname is "Smith" or "Doe"
SELECT * FROM employees WHERE lastname = 'Smith' OR lastname = 'Doe';

--7. Select all data of employees that works in department 14
...
--10. Select the number of employees in each department. You only need to show the department code and the number of employees. (Use count(*) operator for counting the number of employees)
